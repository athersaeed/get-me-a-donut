    ...
    return (
        <nav className="flex justify-between items-center p-4 md:px-8 bg-blue-950 border-t border-neutral-800 text-white sticky top-0 backdrop-blur-md z-10">
            <div className="logo flex items-center gap-2 justify-center font-bold text-lg">
                <span>
                <Link href="/"><img width={40} src="tea.gif" alt="" /></Link>
                </span>
                ...
                <div className='flex gap-4 items-center ml-4'>
                    <li>
                        ...
                        {session && <div className="relative inline-block text-left">
                            <button onClick={() => setDropdown(!dropdown)} className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white/10 px-3 py-2 text-sm font-semibold text-white inset-ring-1 inset-ring-white/5 hover:bg-white/20">
                            ...
                            {dropdown && (
                                <div className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-gray-800 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                    <div className="py-1">
                                        ...
                                        <button onClick={() => signOut()} className="block w-full px-4 py-2 text-left text-sm text-gray-300 hover:bg-gray-700 hover:text-white">Sign out</button>
                                    </div>
                                </div>
                            )}
                        </div>}
